...
# Overview
This project involves the creation of a comprehensive Tableau dashboard to analyze the sales performance and outlet metrics for a grocery service. The dashboard provides key insights into sales trends, outlet performance, and customer behavior, enabling stakeholders to make informed decisions.
